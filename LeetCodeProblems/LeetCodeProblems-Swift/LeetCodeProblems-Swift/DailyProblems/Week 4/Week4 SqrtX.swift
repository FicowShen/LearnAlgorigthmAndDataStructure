...
final class Week4SqrtX {
    ...
    func newtonIteration7(_ x: Int) -> Int {
        fatalError()
    }

    func binarySearch7(_ x: Int) -> Int {
        fatalError()
    }
    ...
    func newtonIteration6(_ x: Int) -> Int {
        fatalError()
    }

    func binarySearch6(_ x: Int) -> Int {
        fatalError()
    }
    ...
    func newtonIteration5(_ x: Int) -> Int {
        var r = x
        while r * r > x {
            r = (r + x/r) >> 1
        }
    ...
    func binarySearch5(_ x: Int) -> Int {
        var l = 0, r = x, ans = 0
        while l <= r {
            let mid = l + (r - l) >> 1
            if mid * mid <= x {
    ...
    func newtonIteration4(_ x: Int) -> Int {
        var r = x
        while r * r > x {
            r = (r + x/r) >> 1
        }
    ...
    func binarySearch4(_ x: Int) -> Int {
        var l = 0, r = x, ans = 0
        while l <= r {
            let mid = l + (r - l) >> 1
            if mid * mid <= x {
